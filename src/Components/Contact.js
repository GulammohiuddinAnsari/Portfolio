...
const formApi = "https://formspree.io/f/mldgledg";
  ...
  return (
    <div name="Contact" className="w-full min-h-screen bg-gradient-to-b from-black to-gray-800 text-white flex flex-col justify-center items-center">
      ...
      <div className="w-full h-full flex flex-col items-center py-14">
        ...
        <div className="py-12">
          <p className="text-4xl font-bold border-b-4 border-gray-500">Contact Me!</p>
        </div>
        ...
        <div className="w-2/4">
          ...
          <form action={formApi} method="POST" className="flex flex-col gap-5">
               ...
               <button className="text-white bg-gradient-to-b from-cyan-500 to-blue-500 px-6 py-3 my-4 mx-auto flex items-center hover:scale-110 duration-300 rounded-md">Send</button>
          </form>
        </div>
      </div>
    </div>
